...
export const getTrelloUserDGCardsRelatedToMember = (state, member) =>
  state.trelloUserState.user.sprintColumn.cards.filter(card => member.dailyCards.includes(card.id));
